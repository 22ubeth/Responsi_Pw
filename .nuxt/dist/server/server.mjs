...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-T8V2vU2U.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BBtBEX9l.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cz2ZI78G.js").then((r) => r.default || r));
